      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                // Thêm logic xử lý khi người dùng nhấn nút "Nạp Tiền"
              },
            ...
            // if (widget.userInfoResponse.userBanks.isNotEmpty)
            //   buildBankSection('User Banks', widget.userInfoResponse.userBanks),
            // ElevatedButton(
            //   onPressed: () {
            //     // Add logic to navigate or show a modal for adding a new bank
            //   },
            //   child: const Text('Thêm Ngân Hàng'),
            //   style: ElevatedButton.styleFrom(primary: const Color.fromARGB(255, 54, 174, 244)),
            // ),
          ],
        ),
      ),
