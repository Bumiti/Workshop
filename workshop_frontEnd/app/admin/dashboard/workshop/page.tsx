          ...
          {selectedUser && (
            <Card className={Style.container}>
              <Card.Body className={Style.form}>
                <Card.Title><text>Course Name : {selectedUser.name}</text></Card.Title>
                ...
                <Card.Text><text>Start Date: {selectedUser.startDate}</text></Card.Text>
                <Card.Text><text>End Date: {selectedUser.endDate}</text></Card.Text>
                ...
                <Card.Text><text>End Date: {selectedUser?.courseLocations[0]?.area}</text></Card.Text>
                        ...
                        <text>{courselocation.area},
                          ...
                          {(!courselocation.locationDTO.name) && (
                            <div>
                              ...
                              <button className={Style.btn1} onClick={() => UpdateLocationWorkshop(courselocation.id!, locationIds[courselocation.id!]!)}> submit</button>
